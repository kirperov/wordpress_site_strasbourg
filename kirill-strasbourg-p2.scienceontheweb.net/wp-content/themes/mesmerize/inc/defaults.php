...
function mesmerize_theme_defaults()
{
    ...
    $defaults = array(
        ...
        3 => array(
            ...
            "enable_top_bar"                => false,
            "header_front_page_image"       => get_template_directory_uri() . "/assets/images/home_page_header-3.jpg",
            "inner_header_front_page_image" => get_template_directory_uri() . "/assets/images/home_page_header-3.jpg",
