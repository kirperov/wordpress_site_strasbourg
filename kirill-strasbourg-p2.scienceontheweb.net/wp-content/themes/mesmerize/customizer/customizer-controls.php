...
class Info_Control extends \WP_Customize_Control
{
    ...
    public function render_content()
    {
        ...
        $proLink   = esc_url("http://extendthemes.com/go/mesmerize-upgrade");
    ...
    protected function render()
    {
        ...
        <li id="accordion-section-<?php echo esc_attr($this->id); ?>" class="<?php echo esc_attr($classes); ?>">
            <div class="ope-pro-header accordion-section-title">
                <a href="https://extendthemes.com/go/mesmerize-upgrade/" target="_blank" class="button"><?php _e("Upgrade to PRO", 'mesmerize') ?></a>
            </div>
        </li>
